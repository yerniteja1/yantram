...
// Live client-ready demos built by Yerni — each card links to the
// deployed demo site.
...
const WORKS = [
  {
    ...
    built: "What Yerni built: menu with categories, table reservation flow, and location with maps.",
  ...
  },
  {
    ...
    built: "What Yerni built: service bookings, pet listings, and a mini shop with category tabs.",
  ...
  },
  {
    ...
    built: "What Yerni built: Book Campus Visit flow, admission enquiry over WhatsApp, and admin-editable content.",
  ...
  },
  {
    ...
    built: "What Yerni built: treatment catalog, doctor profiles, and WhatsApp appointment flow.",
  ...
  },
  {
    ...
    built: "What Yerni built: live attendance, marks entry with analytics, and Principal / Teacher / Parent role views.",
  ...
  },
  {
    ...
    built: "What Yerni built: Find Your Batch widget, course tracks, and WhatsApp demo booking flow.",
  ...
  },
  {
    ...
    built: "What Yerni built: service catalog, WhatsApp booking flow, and admin-editable content.",
  ...
  },
  {
    ...
    built: "What Yerni built: membership tiers, trainer profiles, and WhatsApp trial booking.",
  ...
  },
  {
    ...
    built: "What Yerni built: service menu, appointment booking over WhatsApp, and offer banners.",
  ...
  },
  {
    ...
    built: "What Yerni built: hall listings, package cards, and event enquiry over WhatsApp.",
  ...
  },
  {
    ...
    built: "What Yerni built: room listings, amenity highlights, and WhatsApp reservation flow.",
  ...
  },
  {
    ...
    built: "What Yerni built: searchable listings, price filters, and WhatsApp site-visit scheduling.",
  ...
  },
  {
    ...
    built: "What Yerni built: job listings, application flow over WhatsApp, and trust-building reviews.",
  ...
  },
  {
    ...
    built: "What Yerni built: test search with report times, package cards, and WhatsApp home-collection booking.",
  ...
  },
  {
    ...
    built: "What Yerni built: searchable packages, day-wise itinerary views, and WhatsApp trip planning flow.",
  ...
  },
  {
    ...
    built: "What Yerni built: service catalog with categories, gallery lightbox, and WhatsApp wedding planning flow.",
