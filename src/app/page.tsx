...
const STEPS = [
  { n: "1", icon: "potted_plant", title: "1. Seed", sub: "Discover & Listen", subCls: "text-amber-700", desc: "We uncover your strategic essence, customer behavior, and product objectives before drafting a single pixel.", numBg: "bg-amber-50 border-amber-200 text-amber-700", hoverBorder: "hover:border-amber-400", iconHover: "group-hover:text-amber-700", foot: "text-amber-700", footIcon: "arrow_forward" },
  { n: "2", icon: "polyline", title: "2. Shape", sub: "Design & Prototype", subCls: "text-emerald-800", desc: "Interactive high-fidelity prototypes you can touch, test, and feel in your hand early in the process.", numBg: "bg-emerald-50 border-emerald-200 text-emerald-800", hoverBorder: "hover:border-emerald-500", iconHover: "group-hover:text-emerald-700", foot: "text-emerald-800", footIcon: "arrow_forward" },
  { n: "3", icon: "construction", title: "3. Build", sub: "Craft & Test", subCls: "text-stone-700", desc: "Clean architectural code built to endure. Thorough unit tests, performance audits, and human-tested ergonomics.", numBg: "bg-stone-100 border-stone-200 text-stone-800", hoverBorder: "hover:border-stone-400", iconHover: "group-hover:text-stone-800", foot: "text-stone-700", footIcon: "arrow_forward" },
  { n: "4", icon: "eco", title: "4. Flourish", sub: "Launch & Scale", subCls: "text-amber-700", desc: "Smooth deployment, clear handover docs, and ongoing observation to guide continuous market growth.", numBg: "bg-amber-50 border-amber-200 text-amber-700", hoverBorder: "hover:border-amber-400", iconHover: "group-hover:text-amber-700", foot: "text-amber-700", footIcon: "check_circle" },
];
